...
const skeletonByVariant = {
  ...
  [SKELETON_VARIANTS.usersForm]: (pathname) => (
    <UserFormPageSkeleton mode={pathname.endsWith('/tahrirlash') ? 'edit' : 'create'} />
  ),
...
export const RoutePageSkeleton = () => {
  ...
  if (variant === SKELETON_VARIANTS.usersForm) {
    return skeletonByVariant[SKELETON_VARIANTS.usersForm](pathname)
  }
