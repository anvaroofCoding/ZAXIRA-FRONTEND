...
const CommissionsTableRowSkeleton = () => (
  <TableRow>
    <TableCell width={200}>
    ...
    <TableCell>
      <Stack direction="row" gap={0.75}>
        ...
        <SkeletonBlock height={24} width={110} sx={{ borderRadius: 2 }} />
      </Stack>
    </TableCell>
    <TableCell width={80}>
...
export const CommissionsPageSkeleton = ({ showAddButton = true }) => (
  <Box
    aria-busy="true"
    aria-label="Komissiyalar yuklanmoqda"
  ...
  >
    ...
    >
      <Stack spacing={0.5} sx={{ flex: 1, minWidth: 200 }}>
        <SkeletonBlock variant="text" width={220} height={32} />
        <SkeletonBlock variant="text" width={{ xs: '100%', sm: 380 }} height={20} />
      </Stack>
      ...
      <Table size="small" stickyHeader>
        ...
        <TableBody>
          {Array.from({ length: ROW_COUNT }).map((_, index) => (
            <CommissionsTableRowSkeleton key={index} />
          ))}
        </TableBody>
      </Table>
    </TableContainer>
